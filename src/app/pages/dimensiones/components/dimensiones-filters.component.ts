/**
 * DimensionesFiltersComponent - Filtros para dimensiones
 */
...
@Component({
  selector: 'app-dimensiones-filters',
  standalone: true,
...
export class DimensionesFiltersComponent {
  @Input() search = '';
